$( document ).ready(function() {
  ...
  let bottBtn = $('.main-btn');
  
  let sectioPortfolio = $('#portfolio-area');

  let scrollBtn = '';

  $(bottonBtn).click(function(){
    
    let bottonId = $(this).attr('id');

    if(bottonId == 'portfolio-btn'){
        scrollBtn = sectioPortfolio;
    }else{
        
        scrollBtn = portfolioSection;
    }
    $([document.documentElement, document.body]).animate({
        scrollBtn: $(scrollBtn).offset().top - 70
    },1500);
  });
